...
package allen.town.focus.twitter.transaction;

public class KeyProperties {

    public static final String PATH = "/Focus_for_Mastodon_tweets";
    public static final String PATH_NOTIFICATION = "/Focus_for_Mastodon_notification";
