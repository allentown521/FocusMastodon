...
public final class ParseUtil {
    ...
    public static Date parseTrendsDate(String asOfStr) throws Exception {
        Date parsed;
    ...
    public static Date getDate(String name, JSONObject json) throws Exception {
        return getDate(name, json, "EEE MMM d HH:mm:ss z yyyy");
    }

    public static Date getDate(String name, JSONObject json, String format) throws Exception {
    ...
    public static Date getDate(String dateString, String format) throws Exception {
        ...
        try {
            ...
            throw new Exception("Unexpected date format(" + dateString + ") returned from twitter.com", pe);
        } finally {
            try {
