...
class PurchaseActivity : WhiteToolbarActivity() {
    ...
    @JvmField
    @BindViews(
        R.id.upgradeImage0,R.id.upgradeImage1,R.id.upgradeImage2,R.id.upgradeImage3,R.id.upgradeImage4,R.id.upgradeImage5,
    )
    var actionsIcons: List<@JvmSuppressWildcards ImageView>? = null

    @JvmField
    @BindViews(
        R.id.upgradeText0,R.id.upgradeText1,R.id.upgradeText2,R.id.upgradeText3,R.id.upgradeText4,R.id.upgradeText5,
    )
