...
public class InteractionClickListener implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(mTitle.contains(context.getResources().getString(R.string.mentioned_by))) { // this is a mention
            if (MainDrawerArrayAdapter.current < 3) {
                ...
                new TimeoutThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        intent.putExtra(AppSettings.PAGE_TO_OPEN, mentionsPage);
            ...
            final String[] fItems = data.getUsers(sharedPreferences.getInt(AppSettings.CURRENT_ACCOUNT, 1),
                    i,
        ...
        data.markRead(sharedPreferences.getInt(AppSettings.CURRENT_ACCOUNT, 1), i);
