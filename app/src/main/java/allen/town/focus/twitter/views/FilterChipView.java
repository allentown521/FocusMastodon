...
public class FilterChipView extends AppCompatButton {
	...
	public FilterChipView(Context context, AttributeSet attrs, int defStyle){
		...
		setCompoundDrawableTintList(ColorStateList.valueOf(UiUtils.getThemeColor(context, R.attr.colorOnSurface)));
		updatePadding();
	}
