...
public class UserTweetsSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table "
            ...
            + " text mention, " + COLUMN_USERS
            + " text users, " + COLUMN_RETWEETER
            + " text original name, " + COLUMN_USER_ID
    ...
    public UserTweetsSQLiteHelper(Context context) {
