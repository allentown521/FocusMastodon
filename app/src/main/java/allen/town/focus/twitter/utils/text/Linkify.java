...
class Linkify {
    ...
    public static void addLinks(Context context, TextView text, Pattern pattern, boolean extBrowser) {
        addLinks(context, text, pattern, null, null, null, "", extBrowser);
    }
    ...
    public static void addLinks(Context context, TextView text, Pattern p,
                                MatchFilter matchFilter, TransformFilter transformFilter, TextView tv, String allUrls, boolean extBrowser) {
        SpannableString s = SpannableString.valueOf(text.getText());

        if (addLinks(context, s, p, matchFilter, transformFilter, tv, allUrls, extBrowser)) {
            text.setText(s);
    ...
    private static boolean addLinks(Context context, Spannable s, Pattern p,
                                    ...
                                    TransformFilter transformFilter, TextView tv, String allUrls, boolean extBrowser) {
        ...
        while (m.find()) {
            ...
            if (allowed) {
                ...
                Timber.v( "longurl: " + longUrl);
                Timber.v( "shorturl: " + shortUrl);

                applyLink(context, new Link(shortUrl, longUrl), start, end, s, extBrowser);
                hasMatches = true;
            }
        }
    ...
    private static void applyLink(Context context, Link url, final int start, final int end, final Spannable text, boolean extBrowser) {
