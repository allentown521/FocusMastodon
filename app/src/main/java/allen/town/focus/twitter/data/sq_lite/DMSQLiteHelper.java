...
public class DMSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table "
            ...
            + " text users, " + HomeSQLiteHelper.COLUMN_NOTIFICATION_ID
            + " text notification_id, " + COLUMN_RETWEETER
    ...
    private static final String DATABASE_ADD_CONVO_FIELD =
            "ALTER TABLE " + TABLE_DM + " ADD COLUMN " + COLUMN_CONVERSATION + " INTEGER DEFAULT 0";
